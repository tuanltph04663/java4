...
<link rel="stylesheet" type="text/css" href="mos-css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="mos-css/font-awesome.min.css">
</head>
...
<div id="wrapper">
	...
	<ul>
		...
		<li><a href="KhachHang.jsp">Thành Viên</a></li>
	</ul>
	</div>
	<div id="rightContent">
	<h3>Dashboard</h3>
